<script lang="ts">
    ...
    let { questionId, questionText, topicId, onComplete } = $props();
    ...
    async function handleOptionClick(option: Option) {
        ...
        try {
            ...
            console.log('Debug - Answer submission result:', result);
            ...
            console.error('Debug - Error in handleOptionClick:', error);
            errorState.showError('Failed to save answer');
        }
    }
